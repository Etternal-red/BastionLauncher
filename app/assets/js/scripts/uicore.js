...
remote.getCurrentWebContents().on('devtools-opened', () => {
    console.log('%cSolo usa esta consola en caso de reportar errores. No introduzcas nada que no sepas exactamente *qué* significa.', 'font-size: 16px')
})
        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/Etternal-Red/BastionLauncher/releases/download/v${info.version}/helioslauncher-setup-${info.version}.dmg`
                    showUpdateUI(info)
                }
