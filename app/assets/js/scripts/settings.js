        ...
        authAccountStr += `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            ...
            <div class="settingsAuthAccountRight">
                ...
                <div class="settingsAuthAccountActions">
                    <button class="settingsAuthAccountSelect" ${selectedUUID === acc.uuid ? 'selected>Cuenta seleccionada &#10004;' : '>Select Account'}</button>
...
function populateVersionInformation(version, valueElement, titleElement, checkElement){
    ...
    if(isPrerelease(version)){
        titleElement.innerHTML = 'Versión beta'
        titleElement.style.color = '#ff886d'
        checkElement.style.background = '#ff886d'
    } else {
        titleElement.innerHTML = 'Versión estable'
...
function populateSettingsUpdateInformation(data){
    if(data != null){
        settingsUpdateTitle.innerHTML = `Hay una nueva ${isPrerelease(data.version) ? 'beta' : 'versión'} disponible`
        ...
        if(process.platform === 'darwin'){
            settingsUpdateButtonStatus('Descarga desde Github<span style="font-size: 10px;color: gray;text-shadow: none !important;">Cerra el launcher e inicia el dmg para empezar la actualización.</span>', false, () => {
        ...
        settingsUpdateTitle.innerHTML = 'Estas en la ultima versión del launcher'
